  ...
  return (
    <div className="space-y-6 font-sans">
        ...
        <div className="space-y-8 animate-in fade-in duration-200">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-[#173541] pb-3">
              ...
              <span className="text-xs font-bold text-[#19D89A] bg-[#19D89A]/10 border border-[#19D89A]/30 px-3 py-1 rounded-full">
                Latest Match (1 of {matches?.length || 0})
              </span>
            </div>
      ...
      <nav 
        ...
        className="fixed bottom-0 left-0 right-0 z-40 bg-[#0D1528]/95 backdrop-blur-xl border-t border-[#173541] shadow-[0_-8px_30px_rgba(0,0,0,0.6)] py-2 px-2 sm:px-4"
      >
